...
public class Login extends JFrame {
	...
	/**
	 * Panneau principal contenant les composants de la fenêtre.
	 * JPanel est utilisé pour organiser et contenir les différents éléments de l'interface graphique.
	 */
     ...
     * JTextField est utilisé pour entrer le login (adresse email) de l'utilisateur.
     */
	private JTextField champTexteLogin; // Champ pour saisir l'adresse email
    /**
     * Champ de saisie pour le mot de passe.
     * JPasswordField est utilisé pour masquer le texte saisi par l'utilisateur.
     */
