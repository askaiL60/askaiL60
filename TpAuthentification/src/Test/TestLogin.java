...
class TestLogin {
    ...
    void testValiderEmail() {
        ...
        assertFalse(login.validerEmail("utilisateur@domaine"), "L'email utilisateur@domaine (manque TLD) ne doit pas être valide.");
        assertFalse(login.validerEmail("utilisateurdomaine.com"), "L'email utilisateurdomaine.com (manque @) ne doit pas être valide.");
        assertFalse(login.validerEmail("@domaine.com"), "L'email @domaine.com (manque partie locale) ne doit pas être valide.");
        assertFalse(login.validerEmail("user@.com"), "L'email user@.com (manque domaine) ne doit pas être valide.");
        assertFalse(login.validerEmail("user@domain..com"), "L'email user@domain..com (double point) ne doit pas être valide.");
    }
